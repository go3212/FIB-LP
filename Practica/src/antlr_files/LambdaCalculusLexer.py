...
def serializedATN():
    return [
        ...
        18,4,1,0,0,0,19,20,5,92,0,0,20,6,1,0,0,0,21,22,5,46,0,0,22,8,1,0,
        0,0,23,24,5,955,0,0,24,10,1,0,0,0,25,26,7,0,0,0,26,12,1,0,0,0,27,
...
class LambdaCalculusLexer(Lexer):
    ...
    ruleNames = [ "T__0", "T__1", "T__2", "T__3", "LAMBDA", "VARIABLE", 
                  "WS" ]
